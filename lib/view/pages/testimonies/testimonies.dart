...
class TestimoniesScreen extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return TestimoniesScreenState();
  }
}

class TestimoniesScreenState extends State<TestimoniesScreen> {
  @override
        ...
        body: RefreshIndicator(
          ...
          onRefresh: () async {
            return Future<void>.delayed(const Duration(milliseconds: 600),
                () async {
              var newTestimonies = await TestimoniesApi().getTestimonies();
              setState(() {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding:
                            EdgeInsets.only(left: 14, right: 14, bottom: 20),
                        child: Column(
                          children: [
                            SizedBox(height: 10),
                            Row(
